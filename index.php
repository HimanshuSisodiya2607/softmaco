<!DOCTYPE html><html lang="en"><head>
  ...
  <title>SoftMaco Development Bikaner - IT Company in Rajasthan</title>
<link rel="icon" href="images/favicon.ico"><link href="css/style.css" rel="stylesheet"></head>
...
<body x-data="{ page: 'home', 'loaded': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }">
  ...
  <main>
        ...
        <div class="text-center">
          <a href="/#" class="hero-subtitle-gradient hover:hero-subtitle-hover relative mb-5 font-medium text-sm inline-flex items-center gap-2 py-2 px-4.5 rounded-full">
            ...
            <span class="hero-subtitle-text">
              IT Innovation from Bikaner, Rajasthan
            </span>
          </a>
          <h1 class="text-white mb-6 text-3xl font-extrabold sm:text-5xl xl:text-heading-1">
            SoftMaco Development Bikaner
          </h1>
          <p class="max-w-[500px] mx-auto mb-9 font-medium md:text-lg">
            Professional IT solutions, web and app development, software products, and digital transformation for businesses in Bikaner and beyond.
          </p>
      ...
      <div class="max-w-[1222px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div class="wow fadeInUp text-center">
          ...
          <p class="max-w-[714px] mx-auto mb-5 font-medium">
            At Softmaco, we transform ideas into digital experiences. Our team delivers 
            cutting-edge technology solutions designed to help your business grow faster and smarter
          </p>
        </div>
          ...
          <div class="flex flex-wrap justify-center">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3">
              <div class="group relative overflow-hidden text-center py-8 sm:py-10 xl:py-15 px-4 lg:px-8 xl:px-13">
                ...
                <p class="font-medium">
                  Building fast, secure, and scalable websites tailored to your goals.
                </p>
              </div>
            </div>
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3">
              <div class="group relative overflow-hidden text-center py-8 sm:py-10 xl:py-15 px-4 lg:px-8 xl:px-13">
                ...
                <p class="font-medium">
                  Creating seamless mobile apps for iOS and Android with top-tier performance.
                </p>
              </div>
            </div>
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3">
              <div class="group relative overflow-hidden text-center py-8 sm:py-10 xl:py-15 px-4 lg:px-8 xl:px-13">
                ...
                <p class="font-medium">
                  Crafting intuitive and visually stunning interfaces that enhance user engagement.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-wrap justify-center">
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3">
              <div class="group relative overflow-hidden text-center py-8 sm:py-10 xl:py-15 px-4 lg:px-8 xl:px-13">
                ...
                <p class="font-medium">
                  Delivering creative visuals that elevate your brand identity.
                </p>
              </div>
            </div>
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3">
              <div class="group relative overflow-hidden text-center py-8 sm:py-10 xl:py-15 px-4 lg:px-8 xl:px-13">
                ...
                <p class="font-medium">
                  Driving online visibility and customer growth through strategic campaigns.
                </p>
              </div>
            </div>
            ...
            <div class="w-full sm:w-1/2 lg:w-1/3">
              <div class="group relative overflow-hidden text-center py-8 sm:py-10 xl:py-15 px-4 lg:px-8 xl:px-13">
                ...
                <p class="font-medium">
                  Developing customized software to streamline operations and boost productivity.
                </p>
              </div>
            </div>
          </div>
    ...
    <!-- ====== Team Section Start ====== -->
    <section id="team" class="relative z-20 overflow-hidden pt-22.5 lg:pt-27.5 xl:pt-32.5 pb-20">
      <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        <div class="wow fadeInUp mb-12 text-center z-10 relative">
          <span class="hero-subtitle-gradient relative mb-4 font-medium text-sm inline-flex items-center gap-2 py-2 px-4.5 rounded-full">
            <img src="images/icon-title.svg" alt="icon">
            <span class="hero-subtitle-text"> Our Team </span>
          </span>
          <h2 class="text-white mb-4.5 text-2xl font-extrabold sm:text-4xl xl:text-heading-2">Meet Our Team</h2>
          <p class="max-w-[714px] mx-auto font-medium">
            Our talented professionals drive innovation and deliver digital excellence for Bikaner and clients worldwide.
          </p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-7.5">
          <!-- Team Member 1 -->
          <div class="wow fadeInUp rounded-3xl bg-dark relative z-20 overflow-hidden pt-12.5 pb-10 px-8 xl:px-10">
            <div class="flex flex-col items-center">
              <img src="images/user-01.png" alt="Amit Sharma - CEO" class="w-24 h-24 rounded-full mb-6">
              <h3 class="font-semibold text-lg text-white mb-1">Mahendra Burdak</h3>
              <p class="text-custom-1 mb-3">Co-Founder</p>
              <p class="text-white/70 text-center">Visionary leader with 10+ years in delivering robust IT solutions and growing SoftMaco's impact in Rajasthan.</p>
            </div>
          </div>
          <!-- Team Member 2 -->
          <div class="wow fadeInUp rounded-3xl bg-dark relative z-20 overflow-hidden pt-12.5 pb-10 px-8 xl:px-10">
            <div class="flex flex-col items-center">
              <img src="images/user-02.png" alt="Priya Jain - Lead Developer" class="w-24 h-24 rounded-full mb-6">
              <h3 class="font-semibold text-lg text-white mb-1">Sonu Tanwar</h3>
              <p class="text-custom-1 mb-3">Co-Founder</p>
                ...
                <div class="flex items-center justify-between relative z-20">
                  <div class="max-w-[477px] w-full">
                    ...
                    <h3 class="text-white mb-4.5 font-bold text-heading-4">
                      Transforming Technology Into Possibility
                    </h3>
                    <p class="font-medium mb-10">
                      At Softmaco, we harness the power of innovation and intelligence to craft digital experiences that drive growth,
                       efficiency, and impact. Our mission is to turn complex challenges into simple, elegant tech solutions.
                    </p>
            ...
            <div class="relative rounded-3xl features-box-border">
              <div class="relative overflow-hidden rounded-3xl px-11 pt-12.5 pb-14 box-hover box-hover-small">
                <div class="relative z-20">
                  ...
                  <p class="font-medium">
                    At Softmaco, we design and build intelligent web and 
                    mobile solutions that help businesses scale faster and operate smarter.
                  </p>
                </div>
            ...
            <div class="relative rounded-3xl features-box-border">
              <div class="relative overflow-hidden rounded-3xl px-11 pt-12.5 pb-14 box-hover box-hover-small">
                <div class="relative z-20">
                  ...
                  <p class="font-medium">
                    Our design-first approach blends innovation and aesthetics to 
                    create engaging, futuristic interfaces that leave a lasting impact.
                  </p>
                </div>
    ...
    <section id="pricing" class="relative z-20 overflow-hidden pt-22.5 lg:pt-27.5 xl:pt-32.5 scroll-mt-17">
      <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div class="wow fadeInUp mb-17.5 -mt-24 text-center z-10 relative">
          ...
          <p class="max-w-[714px] mx-auto font-medium">
            Choose a plan that scales with your business. Softmaco’s flexible pricing gives you access to
             premium development, design, and technology services tailored to your needs.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7.5">
          ...
          <div class="wow fadeInUp rounded-3xl bg-dark relative z-20 overflow-hidden pt-12.5 pb-10 px-8 xl:px-10 pricing-item-border">
            ...
            <ul class="flex flex-col gap-4">
              <li class="flex items-center gap-5">
                ...
                <span class="font-medium">Responsive website or landing page</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Basic UI/UX design</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Email & chat support</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Monthly performance report</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Free maintenance for 1 month</span>
              </li>
            </ul>
          ...
          <div class="wow fadeInUp rounded-3xl bg-dark relative z-20 overflow-hidden pt-12.5 pb-10 px-8 xl:px-10 pricing-item-border">
            ...
            <ul class="flex flex-col gap-4">
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Full website or app design</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">API & database integration</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
              ...
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Maintenance & updates</span>
              </li>
          ...
          <div class="wow fadeInUp rounded-3xl bg-dark relative z-20 overflow-hidden pt-12.5 pb-10 px-8 xl:px-10 pricing-item-border">
            ...
            <ul class="flex flex-col gap-4">
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Complete digital solution (web + app + branding)</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Dedicated project manager</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
              ...
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
                <span class="font-medium">Cloud setup & security</span>
              </li>
              <li class="flex items-center gap-5">
                <img src="images/pricing-icon-04.svg" alt="icon">
    ...
    <section x-data="{ 'showContent': false, 'scrollContent': false, }" class="relative z-20 overflow-hidden pt-22.5 lg:pt-27.5 xl:pt-32.5 2xl:pt-45 pb-20">
      <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div class="wow fadeInUp mb-15 text-center">
          ...
          <p class="max-w-[714px] mx-auto font-medium">
            See how Softmaco has transformed ideas into digital success — straight from our clients themselves
          </p>
        </div>
      ...
      <div class="max-w-[1104px] mx-auto px-4 sm:px-8 xl:px-0">
        <div class="relative z-999 overflow-hidden rounded-[30px] bg-dark pt-25 px-4 sm:px-20 lg:px-27.5">
          ...
          <div class="wow fadeInUp mb-16 text-center relative z-999">
            ...
            <p class="max-w-[714px] mx-auto font-medium">
              Join the next wave of digital transformation with Softmaco. Let’s create something extraordinary — together.
            </p>
          </div>
      ...
      <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        <div class="cta-box-gradient bg-dark rounded-[30px] relative overflow-hidden px-4 py-20 lg:py-25 z-999">
          ...
          <div class="wow fadeInUp text-center">
            ...
            <h2 class="text-white mb-4.5 text-2xl font-extrabold sm:text-4xl xl:text-heading-2">
              The Future of Tech Starts with You
            </h2>
            <p class="max-w-[714px] mx-auto font-medium mb-9">
              Join the next wave of digital transformation with Softmaco.
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'99cc6fd44cb924f9',t:'MTc2Mjg0OTkyMw=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script>
