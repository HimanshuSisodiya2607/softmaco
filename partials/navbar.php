        ...
        <ul class="flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-2">
          ...
          <li class="group relative lg:py-7" :class="{ 'lg:!py-4' : stickyMenu }" x-data="{ dropdown: false }">
            ...
            <ul class="dropdown" :class="{ 'flex': dropdown }">
              <li>
                <a href="about.php" class="flex text-sm text-white/70 hover:text-white py-2 px-4 rounded-md hover:bg-white/5" :class="{ '!text-white bg-white/5': page === 'about' }">About SoftMaco</a>
              </li>

              <li>
                <a href="team.php" class="flex text-sm text-white/70 hover:text-white py-2 px-4 rounded-md hover:bg-white/5" :class="{ '!text-white bg-white/5': page === 'team' }">Our Team</a>
              </li>
